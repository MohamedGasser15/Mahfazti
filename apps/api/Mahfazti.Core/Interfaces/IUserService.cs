...
namespace Mahfazti.Core.Interfaces
{
    public interface IUserService
    {
        ...
        Task<ApiResponse<object>> AdminForgotPasswordAsync(string email, string? clientUrl = null);
        ...
        Task<ApiResponse<object>> AdminResetPasswordAsync(AdminResetPasswordDTO dto);
